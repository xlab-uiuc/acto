...
python3 -m acto --config data/cass-operator/v1-22/config-only.json --workdir testrun-cass-conf --num-workers 6

python3 -m acto --config data/tidb-operator/v1-6-0/config-only.json --workdir testrun-tidb-conf --num-workers 3
