...
if __name__ == '__main__':
    ...
    baseline_fp_rate = len(baseline_tf_series[lambda x: x == 'False alarm']) / len(baseline_tf_series)
    ...
    canonicalization_fp_rate = len(canonicalization_tf_series[lambda x: x == 'False alarm']) / len(canonicalization_tf_series)
    ...
    taint_analysis_fp_rate = len(taint_analysis_tf_series[lambda x: x == 'False alarm']) / len(taint_analysis_tf_series)
    ...
    dependency_fp_rate = len(dependency_tf_series[lambda x: x == 'False alarm']) / len(dependency_tf_series)
