if [ $1 = "whitebox" ]
then
    python3 acto.py --config data/percona-xtradb-cluster-operator/config.json --num-workers 12 --num-cases 1 --workdir testrun-xtradb-whitebox --notify-crash
...
then
    python3 acto.py --config data/percona-xtradb-cluster-operator/config.json --blackbox --num-workers 12 --num-cases 1 --workdir testrun-xtradb-blackbox --notify-crash
