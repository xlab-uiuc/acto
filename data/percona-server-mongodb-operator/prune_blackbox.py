...
custom_fields = [
    ...
    input.CopiedOverField(['spec', 'sharding', 'configsvrReplSet', 'arbiter', 'tolerations'], array=True),
    ...
    input.CopiedOverField(['spec', 'sharding', 'configsvrReplSet', 'nonvoting', 'tolerations'], array=True),
    ...
    input.CopiedOverField(['spec', 'sharding', 'configsvrReplSet', 'tolerations'], array=True),
