...
python3 -m plugins.performance_measurement.measure_performance --workdir testrun-anvil-rabbitmq-performance --input-dir anvil-ae-data/testrun-anvil-rabbitmq --anvil-config data/anvil-rabbitmq-operator/config.json --reference-config data/rabbitmq-operator/v2.5.0/config.json --project rabbitmq-operator --sample
echo "RabbitMQ controller performance results are stored in testrun-anvil-rabbitmq-performance"

python3 -m plugins.performance_measurement.measure_performance --workdir testrun-anvil-fluent-performance --input-dir anvil-ae-data/testrun-anvil-fluent --anvil-config data/anvil-fluent-controller/config.json --reference-config data/fluent-operator/config.json --project fluent-operator --sample
